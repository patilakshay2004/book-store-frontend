...
const DashboardLayout = () => {
  ...
  return (
    <section className="flex md:bg-gray-100 min-w-screen ">
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://randomuser.me/api/portraits/men/62.jpg" alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
          ...
          <div className="border-l pl-3 ml-3 space-x-1 ">
            ...
            className="flex gap-1  px-4 py-2 text-purple-600 hover:text-purple-700 focus:text-purple-700 hover:bg-purple-100 focus:bg-purple-100 border border-purple-600 rounded-md mb-3">
